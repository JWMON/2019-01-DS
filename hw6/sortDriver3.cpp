...
int main(int argc, char *argv[]) {
	...
	char option_char;
	char option_str[512];
	char algorithm_list[4][20] = {"Bubble", "Insertion", "Selection", "Quicksort"};
	enum algorithm_enum { BUBBLE, INSERTION, SELECTION, QUICKSORT };
	int  algorithm_chosen = SELECTION;  // default algorithm chosen

	void (*sortFn)(int *, int) = selectionSort;
...
*/
		...
		case 'p':
			if(N <= STARTING_SAMPLES) {
				cout << "For profiling, set sample size > 100" << endl;
				break;
			}
